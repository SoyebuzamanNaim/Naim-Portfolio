...
- **Skills Section** - Interactive skill levels and technology stack
...
- **Vanilla JavaScript** - Theme toggle and interactive features
- **Font Awesome** - Icons library
- **Google Fonts** - Poppins and Momo Signature fonts
...
- **Hero** - Introduction with video background
